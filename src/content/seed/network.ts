...
export const FAQS: SeedFaq[] = [
  {
    ...
    answer: {
      vi: "Hệ thống gồm 7 trường thành viên: Trường Cao đẳng Công nghệ Ngoại thương, Trường Cao đẳng Công nghệ Việt Đức, Trường Trung cấp nghề Quốc tế (IVS), Trường Trung cấp Công nghệ Việt Đức, Trường Trung cấp Bách khoa Vũng Tàu, Trường Trung cấp Việt Hàn và Học viện đào tạo ITW Berlin (CHLB Đức).",
      en: "The system has seven member schools: Foreign Trade Technology College, Viet Duc Technology College, International Vocational School (IVS), Viet Duc Vocational School of Technology, Bach Khoa Vung Tau Vocational School, Viet Han Vocational School, and the ITW Berlin Institute of Training and Education in Germany.",
      de: "Der Verbund umfasst sieben Mitgliedsschulen: Foreign Trade Technology College, Viet Duc Technologie-College, International Vocational School (IVS), Viet Duc Berufsfachschule für Technik, Bach Khoa Vung Tau, Viet Han sowie das itw Berlin in Deutschland.",
      ja: "七つの加盟校で構成されます — 貿易技術短期大学、ベトドゥック工科短期大学、国際職業訓練学校(IVS)、越独技術中級学校、ブンタウ工科中級学校、越韓中級学校、そして ITW ベルリン教育訓練研究所(ドイツ連邦共和国)。",
      ko: "일곱 개 회원 학교로 이루어집니다 — 무역기술전문대학, 비엣득 공과전문대학, 국제직업학교(IVS), 베트남·독일 기술중급학교, 붕따우 공과중급학교, 베트남·한국 중급학교, 그리고 ITW 베를린 교육훈련원(독일 연방공화국).",
      "zh-TW": "體系由七所成員學校組成：外貿科技專科學校、越德科技專科學校、國際職業學校（IVS）、越德科技中級學校、頭頓百科中級學校、越韓中級學校，以及設於德意志聯邦共和國的 ITW 柏林教育訓練學院。",
    },
